...
export function middleware(request: NextRequest) {
    ...
    const csp = [
        ...
        "img-src 'self' data: blob: https://cdn.thegolfpress.com https://a.espncdn.com https://*.espncdn.com https://maps.google.com https://maps.googleapis.com",
        "frame-src 'self' https://maps.google.com https://www.google.com",
        "connect-src 'self' https://cdn.thegolfpress.com https://api.thegolfpress.com https://thegolfpress.com https://*.espn.com",
        "media-src 'self'",
        "object-src 'none'",
        "base-uri 'self'",
        "form-action 'self'",
